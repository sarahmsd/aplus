            ...
            <div class="offre">
                ...
                <div class="offre-left candidature-detail">
                    <div class="entete-offre">
                        <h1 class="form-title">Candidat à l'offre : 12
                            / Designer Graphique</h1>
                    </div>
                    <div class="candidature-content-top">
                        <div class="title-1">
                            <span class="text">Candidat à l’offre Nº12 </span>
                            <span class="bare-vertical">&#124;</span>
                            <a href="" class="lien-offre">Voir l'offre</a>
                        </div>
                        <div class="title-2">
                            <span class="text">Poste: Assistant Comptable  </span>
                            <span class="bare-vertical">&#124;</span>
                            <span class="text">CDD</span>
                            <span class="bare-vertical">&#124;</span>
                            <span class="text">Temps Plein</span>
                        </div>
                    </div>
                    <div class="candidature-content-bottom">
                        ...
                        <div class="infos">
                            ...
                            <div class="right">
                                <span class="text-big">https://www.linkedin.com/babac..</span>
                            </div>
                        </div>
                        <div class="infos message-candidat">
                            ...
                            <div class="right">
                                <p class="message">Mon sens du relationnel me sera également utile pour m’intégrer dans votre équipe particulièrement dynamique. De plus, mon excellent niveau en anglais me permettra de faciliter les échanges avec vos fournisseurs étrangers. </p>
                            </div>
                        </div>
                        <span class="date-envoi">Candidature envoyée le: 26/12/2022 à 16h39mn</span>
                    </div>
                    <div class="btnOffre">
                ...
                <div class="offre-right candidature-detail">
                    <div class="telechargement">
                        <img src="../../public/images/CV-Assistant-Comptable-1.jpeg">
