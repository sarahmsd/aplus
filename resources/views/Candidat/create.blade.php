            ...
            <div class="body-section">
                <div class="wrapper wrapper-two-column">
                    <div class="card card-style-2">
                        ...
                        <div class="card-body">
                            <form action="{{ route('candidats.store') }}" method="POST" class="form text-secondary" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label for="nom" class="form-label">Nom</label>
                                    <input type="text" name="nom" class="form-input input-style-profil">
                                </div>
                                <div class="form-group">
                                    <label for="prenom" class="form-label">Prenom</label>
                                    <input type="text" name="prenom" class="form-input input-style-profil">
                                </div>
                                <div class="form-group">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" name="email" value="{{ auth()->user()->email }}" class="form-input input-style-profil">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="tel" class="form-input input-style-profil">
                                </div>
                                <div class="form-group">
