...
<div class="main-content dashboard-emploi">
    ...
    <div class="entete-main-dashboard">
        <div class="entete-left">
            <h1>Liste des ecoles</h1>
        </div>
        <div class="entete-right">
            <a href="{{  route('admin.ecoles.create') }}" class="button-add">
                <span> Ajouter une nouvelle ecole</span>
            </a>
        </div>
    </div>
    <div class="wrapper">
            ...
            <table class="fl-table table-style-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ecole->systemeEducatif_id == 1 ? 'Français' : ($ecole->systemeEducatif_id == 2 ? 'Anglais US' : 'Anglais UK')  }}</td>
                        <td>{{ $ecole->creator->name ?? ''}}</td>
                        <td>
                            <div class="actions-icons">
                                <a href="{{ route('show.ecole', $ecole->id) }}">
                                ...
                                <a href="{{ route('admin.ecoles.edit', $ecole->id) }}">
