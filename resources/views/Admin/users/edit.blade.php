            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="profil" id="" class="form-input">
                        <option value="Ecole" {{$user->profil === 'Ecole' ? 'selected' : ''}}>Ecole</option>
                        <option value="Employeur" {{$user->profil === 'Employeur' ? 'selected' : ''}}>Employeur</option>
                        <option value="Candidat" {{$user->profil === 'Candidat' ? 'selected' : ''}}>Candidat</option>
                        <option value="admin" {{$user->profil === 'admin' ? 'selected' : ''}}>Admin</option>
                    </select>
                </div>
                <button class="btn btn-fill" type="submit">Modifier</button>
            </form>
        </div>
    </div>
