...
<div class="main-content dashboard-emploi">
            ...
            <div id="test-lien-offre">
                ...
                <div class="cartes candidature">
                    ...
                    @if (!is_null($candidatures) && is_countable($candidatures) && count($candidatures) > 0)
                    ...
                    @foreach ($candidatures as $candidature)
                        ...
                        <div class="carte candidature">
                            <div class="card-offre-left">
                                <a href="" class="logo"><img src="images/{{ $candidature->cv }}" alt="" class="xsmall-media"></a>
                            </div>
                            <div class="card-offre-center">
                                <div class="content-top">
                                    <span>{{ $candidature->offre->nom }}</span>
                                    <span class="title-top">{{ $candidature->user->candidat->nom }} {{ $candidature->user->candidat->prenom }}</span>
                                ...
                                <div class="content-bottom">
                                    ...
                                    <div class="date-envoi">
                                        ...
                                        <span>Envoyée le: {{ $candidature->created_at }}</span>
                                    </div>
                                </div>
                                <div class="right">
                            ...
                            <div class="card-offre-right">
                                ...
                                <div class="offre-right-bottom">
                                    <a href="{{ route('showCandidature', $candidature->id) }}">
