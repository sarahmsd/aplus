...
<div class="main-content dashboard-emploi">
            ...
            <div id="test-lien-offre">
                ...
                <div class="cartes candidature">
                    ...
                    @if (!is_null($candidats) && count($candidats) >0)
                    ...
                    @foreach ($candidats as $candidat)
                        ...
                        <div class="carte candidature">
                            <div class="card-offre-left">
                                <a href="" class="logo"><img src="images/{{ $candidat->cv }}" alt="" class="xsmall-media"></a>
                            </div>
                            <div class="card-offre-center">
                                <div class="content-top">
                                    <span>{{ $offre->nom }}</span>
                                    <span class="title-top">{{ $candidat->nom }} {{ $candidat->prenom }}</span>
                                ...
                                <div class="content-bottom">
                                    ...
                                    <div class="date-envoi">
                                        ...
                                        <span>Envoyé le {{ date('d/m/Y', strtotime( $candidature->created_at )) }}</span>
                                    </div>
                                </div>
                                <div class="right">
