...
<body>
    <header class="l-header">
        <div class="l-header-top">
            ...
            <div class="header-top-icons header-orange">
        ...
        <div class="main-content">
            <div class="form-content">
                <div class="form-title">
                    <h1>Candidature</h1>
                    <h2>Remplissez le formulaire pour postuler à loffre</h2>
                    <div class="buttons">
                ...
                <div class="form-sidebar">
                    <div class="card card-style-readmore">
                        <div class="card-top">
                            <h1>{{ $offre->nom }}</h1>
                            <h2>{{ $employeur->nom }} - @foreach (  $offre->contrat_modes as $contratMode )
                                {{ $contratMode->nom }}
                                @endforeach - {{ $contratType->nom }}</h2>
                            <div class="btn read-more float-animation" id="readmore-btn">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/scss/emploi.css') }}">
...
<body>
        ...
        <header>
            ...
            <label for="menu-bar"><i class="fa-sharp fa-solid fa-bars"></i></label>
            ...
            <div class="navbar-center">
                <ul>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Chercher une école</a></li>
                    </ul>
                    </li>
                    <li><a href="#">Emploi</a>
                        <ul>
                        <li><a href="#">Les offres</a></li>
                        <li><a href="#">Nouvelle Offre</a></li>
                        </ul>
                    </li>
                    <li><a href="#">CvThèque</a></li>
                    <li><a href="#">Projet</a>
                    <ul>
                        <li><a href="#">Poster un projet</a></li>
            ...
            <div class="navbar-right">
                <ul>
                    <li><a href="#"><img src="../../public/images/user.png" alt=""><span>Connexion</span></a></li>
                    <li><a href="#"><img src="../../public/images/drapeau.png" alt=""><span>Langues</span></a></li>
                    <li><a href="#"><img src="../../public/images/world.png" alt=""><span>Pays</span></a></li>
                </ul>
            </div>
        </header>
        <div class="menu-secondaire">
            ...
            <div class="menu-right">
                <ul>
                    <a href="#"><img src="../../public/images/livre.png" alt=""></a>
                    <a href="#"><img src="../../public/images/info.png" alt=""></a>
        ...
        <div class="contenu">
            <div class="candidature">
                <div class="candidature-left">
                    <h1 class="form-title">Candidature</h1>
                     ...
                     <input type="hidden" name="offre" value="{{ $offre->id }}">
                        ...
                        <div class="info-user">
                            <div class="input-user">
                                <label for="cv">Cv<span>(facultatif)</span></label>
                                <input type="text" id="cv" name="cv"/>
                            </div>
                            <div class="input-user">
                                <label for="linkedin">Profil Linkedin<span>(facultatif)</span></label>
                ...
                <div class="candidature-right">
                    <div class="detail-offre">
                        <h1 class="job-title">{{ $offre->nom }}</h1>
                        <h5 class="job-critere">{{ $employeur->nom }} - @foreach (  $offre->contrat_modes as $contratMode )
                            {{ $contratMode->nom }}
                            @endforeach - {{ $contratType->nom }}</h5>
                        <hr>
                        <div id="details">
                            {{$employeur->description}}
                        </div>
                        <div class="read-more">
                            <h2>Voir la description complète de loffre</h2>
                            <div id="read-more-btn">
                                <ion-icon  onclick="myFunction() " id="btn-icon"  name="chevron-down"></ion-icon></div>
                            </div>
                        </div>
                    </div>
                </div>
