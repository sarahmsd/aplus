...
<head>
    ...
    <style>
        .l-banner.banner-one-column {
            background-image: url('<?= asset('images/Banniere_app.png') ?>');
        }
    </style>
</head>
<body>
        ...
        <div class="l-header-bottom">
            <div class="l-nav">
                <ul class="nav-menu menu-bottom">
                    <li class="nav-menu-item">
                        <a href="ecoles.html" class="nav-menu-item-link">Ecole</a>
                    </li>
                    <li class="nav-menu-item">
                        <a href="../emploi/offres.html" class="nav-menu-item-link">Emploi</a>
                    </li>
                    <li class="nav-menu-item">
                        <a href="../projet/home.html" class="nav-menu-item-link">Projet</a>
                    </li>
                    <li class="nav-menu-item">
                        <a href="#" class="nav-menu-item-link">CV Thèque</a>
                    </li>
    ...
    <div class="l-main">
        <div class="l-banner banner-one-column">
            <div class="content">
                <form action="{{ route('ecole.search') }}" class="search-form with-icon">
                <input type="text" name="q" value="{{ request()->q ??  '' }}" id="" class="input-search style-2" placeholder="rechercher une école, une formation...">                    
        ...
        <div class="main-content">
            <div class="wrapper">
                <div class="title-section title-center">
                    <h1>Etablissement de l'année - 2022</h1> 
                    <h2>Etablissement le plus récherché de l'année</h2> 
                </div>
            </div>
            <div class="wrapper">
                <div class="box box-1">
                    <div class="box-left">
                        <img src="{{ asset('images/OIP.jpeg')}}" alt="" class="small-media">
                        <h3>2022-Etablissement de l'annéé</h3>
                    </div>
                    <div class="box-right">
                        <div class="title">
                            <div class="t-left">
                                <h1>SupDeco</h1>
                                <h2>Institut Superieur de commerce</h2>
                            </div>
                            <div class="t-right">
                                <img src="{{ asset('images/LOGO_ACADEMIEPLUS_V3__LOGO 2.png')}}" alt="" class="module-media">
                            </div>
                        </div>
                        <div class="description">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi ipsam laudantium a provident eius recusandae eaque itaque, accusantium numquam! Distinctio!</p>                            
                        </div>
                        <div class="footer">
                            <div class="icons">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                <span class="small-text">contact@ism.com</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                    <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 256c-35.3 0-64-28.7-64-64s28.7-64 64-64s64 28.7 64 64s-28.7 64-64 64z"/>
                                </svg>
                                <span class="small-text">Dakar, Sacre Coeur</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path d="M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z"/>
                                </svg>
                                <span class="small-text">778923421</span>
                            </div>
                            <a class="icon" href="../../modules/Ecole/homepage_ecole.html">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="wrapper">
                <div class="title-section title-center">
                    <h1>Découvrez d'autres écoles </h2>
                    <h2>Déjà classées école du mois</h2>
                </div>
            </div>
            <div class="wrapper">
                <div class="card-grid">
                    ...
                    <div class="box box-1 small">
                        <div class="box-left">
                            <img src="{{ asset('images/school_logo_5e286a6860e85.png')}}" alt="" class="small-media">
                        </div>
                        <div class="box-right ">
                            <div class="title">
                                <div class="t-left">
