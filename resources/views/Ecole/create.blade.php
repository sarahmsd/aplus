            ...
            <div class="l-nav nav-school">
                <ul class="nav-menu nav-vertical">
                    ...
                    <li class="nav-menu-item item-icon">
                        ...
                        <a href="dashboard-ecole.html" class="nav-menu-item-link">Dashboard</a>
                    </li>
                    <li class="nav-menu-item item-icon">
                    ...
                    <li class="nav-menu-item item-icon">
                        ...
                        <a href="departements.html" class="nav-menu-item-link">Départements</a>
                    </li>
                    <li class="nav-menu-item item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" height="24" width="22">
                        ...
                        <a href="filieres.html" class="nav-menu-item-link">Filières</a>
                    </li>
                    <li class="nav-menu-item item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" height="24" width="22">
                        ...
                        <a href="activites.html" class="nav-menu-item-link">Activités</a>
                    </li>
                    <li class="nav-menu-item item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path d="M64 32C64 14.3 49.7 0 32 0S0 14.3 0 32V64 368 480c0 17.7 14.3 32 32 32s32-14.3 32-32V352l64.3-16.1c41.1-10.3 84.6-5.5 122.5 13.4c44.2 22.1 95.5 24.8 141.7 7.4l34.7-13c12.5-4.7 20.8-16.6 20.8-30V66.1c0-23-24.2-38-44.8-27.7l-9.6 4.8c-46.3 23.2-100.8 23.2-147.1 0c-35.1-17.6-75.4-22-113.5-12.5L64 48V32z"/>
                        </svg>
                        <a href="cycles.html" class="nav-menu-item-link">Enseignements</a>
                    </li>
                    <li class="nav-menu-item item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="24" width="22">
        ...
        <div class="main-content">
            <div class="l-header-admin">
                ...
                <div class="line-with-logo">
                    <img src="../../public/images/LOGO_ACADEMIEPLUS_V3_SYMBOL.svg" alt="" srcset="" class="module-media">
                </div>
            </div>
                        ...
                        <div class="wrapper wrapper wrapper-two-column">
                            <div class="card card-style-2 boxed">
                                ...
                                <div class="disabled" id="2">
                                    <div class="wrapper wrapper-flex">
                                        <div class="form-radio ens">
                                            <input type="checkbox" id="uk-higher-school" name="uk-higher-school" class="radio-input">
                                        ...
                                        <div class="form-radio ens">
                                            <input type="checkbox" id="uk-secondary-school" name="uk-secondary-school" value="1" class="radio-input">
                                        ...
                                        <div class="form-radio ens">
                                            <input type="checkbox" id="uk-primary-school" name="uk-primary-school" value="1" class="radio-input">
                                        ...
                                        <div class="form-radio ens">
                                            <input type="checkbox" id="uk-nursery-school" name="uk-nursery-school" value="1" class="radio-input">
                                            <label cla
                                ...
                                <div class="disabled" id="3">
                                    <div class="wrapper wrapper-flex">
                                        <div class="form-radio ens">
                                            <input type="checkbox" id="us-higher-school" name="enseignement[]" value="8"lass="radio-input">
                                            <label class="radio-label" for="us-higher-school">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon-radio" viewBox="0 0 512 512">
                                                    <path d="M243.4 2.6l-224 96c-14 6-21.8 21-18.7 35.8S16.8 160 32 160v8c0 13.3 10.7 24 24 24H456c13.3 0 24-10.7 24-24v-8c15.2 0 28.3-10.7 31.3-25.6s-4.8-29.9-18.7-35.8l-224-96c-8.1-3.4-17.2-3.4-25.2 0zM128 224H64V420.3c-.6 .3-1.2 .7-1.8 1.1l-48 32c-11.7 7.8-17 22.4-12.9 35.9S17.9 512 32 512H480c14.1 0 26.5-9.2 30.6-22.7s-1.1-28.1-12.9-35.9l-48-32c-.6-.4-1.2-.7-1.8-1.1V224H384V416H344V224H280V416H232V224H168V416H128V224zm128-96c-17.7 0-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32s-14.3 32-32 32z"/>
                                                </svg>
                                                <div class="text">Higher School</div>
                                        ...
                                        <div class="form-radio ens">
                                            ...
                                            <label class="radio-label" for="us-middle-school">
                                                ...
                                                <div class="text">Middle School</div>
                                            </label>
                                        </div>
                                        <div class="form-radio ens">
                            ...
                            <div class="card card-style-2 boxed">
                                <div class="e-sup cycle disabled">
                                    ...
                                    <div class="wrapper wrapper-flex">
                                        ...
                                        <div class="form-group">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="cycle[]" value="21">
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                ...
                                <div class="e-sec cycle disabled">
                                    ...
                                    <div class="wrapper wrapper-flex">
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="cycle[]" value="8" checked>
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="cycle[]" value="10">
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                ...
                                <div class="uk-higher-school cycle disabled">
                                    ...
                                    <div class="wrapper wrapper-flex">
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="associate-degree" checked>
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="bachelor-degree" checked>
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="master-degree">
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="php-degree">
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                ...
                                <div class="uk-secondary-school cycle disabled">
                                    ...
                                    <div class="wrapper wrapper-flex">
                                        ...
                                        <div class="form-group detail-item">
                                            <label class="toggler-wrapper style-1">
                                                <input type="checkbox" name="sixthFromCollege" checked>
                                                <div class="toggler-slider">
                                                <div class="toggler-knob"></div>
                                                </div>
                                            </label>
                                ...
                                <div class="uk-primary-school cycle disabled">
                                    ...
                                    <div class="wrapper wrapper-flex">
                                        ...
                                        <div class="form-group detail-item">
                                            ...
                                            <div class="badge">Junior School</div>
                                        </div>
                                    </div>
                                </div>
