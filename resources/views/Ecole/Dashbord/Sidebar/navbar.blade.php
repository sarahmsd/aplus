        ...
        <div class="main-content">
            <div class="l-header-admin">
                <div class="">
                    ...
                    <ul class="header-top-icons-menu">
                        ...
                        <li class="header-top-icon-menu-item">
                            <svg class="svg svg-gris" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div class="line-with-logo">
                    <img src="{{ isset($logo) && file_exists('images/ecoles/'. auth()->user()->ecole->id .'/logo/' . $logo->media) ? asset('images/ecoles/'. auth()->user()->ecole->id .'/logo/'. $logo->media) : asset('images/LOGO_ACADEMIEPLUS_V3__SYMBOL.png') }}" alt="" class="header-logo-img">
                </div>
            </div>
            @yield('content')
        </div>
