        ...
        <div class="wrapper">
            ...
            <div class="card card-style-1 card-red">
                ...
                <div class="card-buttons">
                    ...
                    <a class="icon" href="{{ route('delete.departement', $departement->id) }}">
            ...
            <div class="card-down-details disabled">
                <div class="wrapper">
                    <h3>Les filières du département {{ $departement->nomDepartement }}</h3>
                </div>
                <form action="" method="post">
                    <div class="details">
                        ...
                        <div class="form-group detail-item">
                            ...
                            <div class="badge">{{$filiere->nomFiliere}}</div>
                        </div>
                        @endforeach
                    </div>
