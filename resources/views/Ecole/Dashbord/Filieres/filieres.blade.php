...
@section('content')
    <div class="main-section">
        <div class="title-section dashboard-title">
            ...
            <a href="{{ route('filiere.add') }}" class="btn btn-icon">
        ...
        <div class="wrapper">
            ...
            <div class="card card-style-1 card-red">
                <div class="card-left">
                    ...
                    <h4>{{ Str::limit($filiere->departement->nomDepartement, 10) }}</h4>
                </div>
                <div class="card-details">
                    <div>
                        ...
                        <span class="icon">
                            ...
                            {{ $acreditation->nomAcreditation }}
                        </span>
                        @endforeach
                    </div>
                </div>
                <div class="card-buttons">
                    <a href="{{ route('show.filiere', $filiere->id) }}" class="icon">
                    ...
                    <a href="{{ route('edit.filiere',$filiere->id) }}" class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            @endforeach
            @else
            <p class="small-text">Vous n'avez pas encore de filière. <a href="{{ route('filiere.add') }}">ajoutez-en</a></p>
            @endif
        </div>

        @if(isset($filieres) && !empty($filieres))
            {{ $filieres->links('vendor.pagination.custom') }}
        @endif
    </div>
