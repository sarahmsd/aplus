@extends('Ecole.Dashbord.Sidebar.navbar', ['sigle' => auth()->user()->name, 'logo' => $logo])
@section('content')
    <div class="main-section">
        <div class="title-section dashboard-title">
            ...
            <a href="{{ route('configuration') }}" class="btn btn-icon">
        ...
        <div class="wrapper wrapper-two-column">
            <div class="card card-style-2 boxed">
                ...
                <img src="{{ isset($cover) && $cover != null ? asset('images/ecoles/'.$ecole->id.'/'. $cover->media) : '' }}" alt="photo de couverture" class="xsmall-media">
                @if (isset($cover))
            ...
            <div class="card card-style-2 boxed">
                ...
                <img src="{{ isset($logo) && $logo != null ? asset('images/ecoles/'.$ecole->id.'/logo/'.$logo->media) : ''}}" alt="photo de couverture" class="xsmall-media">
                @if (isset($logo))
