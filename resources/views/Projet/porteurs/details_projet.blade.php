        ...
        <div class="l-header-top">
            ...
            <div class="l-nav">
                <ul class="nav-menu menu-top">
                    ...
                    <li class="nav-menu-item">
                        <a href="homeProjet" class="nav-menu-item-link">Projet</a>
                    </li>
                    <li class="nav-menu-item">
        ...
        <div class="l-header-bottom">
            <div class="l-nav">
                <ul class="nav-menu menu-bottom">
                    ...
                    <li class="nav-menu-item">
                        <a href="" class="nav-menu-item-link">Conversation</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="l-infos-projet">
            ...
            <div class="box box-style-3">
                <div class="box-left">
                    ...
                    <div class="buttons">
                        <button class="btn btn-fill">Modifier</button>
                        @if ($projet->status == 0)
                        <button class="btn">En attente de validation</button>
                        @else
            ...
            <div class="wrapper wrapper-four-columns">
                ...
                <form action="{{ route('add.projet', [$investisseur->id]) }}" method="post">
                    ...
                    <div class="box box-style-1">
                        <div class="box-title">
                            <img class="startup-logo-img" src="{{ asset('images/google.webp') }}" alt=""></span>
                            <h1 class="startup-title">{{ $investisseur->user->name }}</h1>
                        </div>
                        ...
                        @if ($projet->status == 0)
                        <button type="submit" class="btn btn-fill btn-retirer-investisseur">Retirer</button>
