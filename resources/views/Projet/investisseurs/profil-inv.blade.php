            ...
            <div class="l-nav nav-school">
                ...
                <ul class="nav-menu nav-vertical">
                    <li class="nav-menu-item item-icon">
                        <a href="dashboard_investisseur.html" class="nav-menu-item-link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-menu-item item-icon active">
                        <a href="profil-inv.html" class="nav-menu-item-link">
        ...
        <div class="main-content">
            ...
            <div class="main-section">
                <div class="title-section dashboard-title">
                    ...
                    <a href="dashboard_investisseur.html" class="btn btn-fill btn-orange">
                ...
                <div class="wrapper wrapper-two-column">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom" class="form-input input-style-2">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="activite" class="form-label">Domaine D'activité</label>
                                    <input type="text" name="activite" class="form-input input-style-2">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="">
                        <div class="card card-style-2 boxed">
                            ...
                            <img src="../../public/images/entretien.jpeg" alt="" class="module-media">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="file" name="photo-profil" id="" class="form-input input-style-2">
                                </div>
                        ...
                        <div class="card card-style-2 boxed">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="password" name="old-password" id="" class="form-input input-style-2" placeholder="mot de paase actuel">
                                </div>
                                <div class="form-group">
                                    <input type="password" name="new-password" id="" class="form-input input-style-2" placeholder="nouveau mot de passe">
                                </div>
