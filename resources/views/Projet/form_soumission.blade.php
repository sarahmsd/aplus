...
<body>
    ...
    <div class="l-main">
        <div class="l-annonce annonce-inline">
        ...
        <div class="form-content">
            <div class="form-title">
                ...
                <div class="buttons">
                    <button class="btn">Suis-je éligible?</button>
                    <button class="btn btn-fill">Tout sur A+ Project</button>
                </div>
            </div>
            ...
            <div class="form-sidebar sidebar-right">
                <div class="box box-style-2">
                    <div class="box-title">
                        <h1>Meilleur projet de la session 4</h1>
                    </div>
                ...
                <div>
                    <img src="{{ asset('images/icon.jpg') }}" alt="" class="small-media">
                </div>
            </div>
        </div>
    </div>
